export default function Head() {
  return (
    <>
      <title>YUGEN School of Accounting and Taxation - Kottakkal</title>
      ...
      <meta property="og:url" content="https://yugenkottakkal.com/" />
      <meta property="og:image" content="/img/logo-light.png" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="YUGEN School of Accounting and Taxation - Kottakkal" />
      <meta name="twitter:description" content="YUGEN School of Accounting & Taxation Kottakkal offers industry-aligned training with real-time examples to prepare students for careers in accounting and taxation. We provide flexible classroom and online training, including weekend and fast-track options. Students can choose convenient time slots, with sessions available on weekdays (morning/evening) and weekends." />
